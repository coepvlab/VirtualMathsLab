...
//
//@Service
//public class CreatePdfReportServiceImpl implements CreatePdfReportService {
//
//	private static final Logger LOGGER = Logger.getLogger(CreatePdfReportServiceImpl.class);
//
//	@Autowired
...
//		String imgUrl_ITOTitle = Constants.imageBaseURL + "RotaryVirtualMathsLab.png";
...
//		String HTML = null;
//		for (TestInstanceState testInstanceState : recordWithTestCompleteNoPDF) {
//
//			long totalQues = 0;
...
//					+ "        background-color: #346ba2 !important; color: #ffffff; font-family:lato !important; font-weight: bold; padding:5% 5% 2% 5%; float: left;\">TEST DETAILS</td>"
...
////						+ "      <div id=\"pieChart\">" + "      </div>" + "    </div>         <div id=\"piechart\"> <img alt=\"Rotary Club\" src='"+PIE_IMG_DEST+testInstanceState.getUser().getUserId()+"_Round_"+testInstanceState.getTestLevel()+".jpg' style=\"width: 585px; height: 200px; !important;\"/>"
...
////					+ "<br/><span style=\"font-size: 12px;\"><b>Dr. Deepak Kelkar <br/>Project-Chair<br/>
...
//	    	String url = Constants.srcURLForSinglePdfResult + date + "/";
//	    	String dest = Constants.destURLForSinglePdfResult + "MergeFile_result_"+ date +".pdf";
...
//	 	    for (File file : fList){
//	 	        if (file.isFile()){ 	        	 
//	 	        	 inputPdfList.add(new FileInputStream(url + file.getName()));
//	 	        }
//	 	    }
//	    	
...
//	    Document document = new Document(PageSize.LEGAL,100f,-25f,0f,0f);
