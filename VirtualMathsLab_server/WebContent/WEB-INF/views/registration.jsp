...
<link rel="stylesheet"
	href="resource/css/jquery-ui-timepicker-addon.min.css" />
			...
			<div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
				<ul class="nav nav-pills" hidden>
					<li class="nav-item"><a class="nav-link " data-toggle="pill"
						href="#student" id="studLink" role="tab"
						aria-controls="pills-flamingo" aria-selected="true">Student
							Registration</a></li>
				</ul>
				<div class="tab-content mt-3">
					...
					<div class="tab-pane fade show " id="student" role="tabpanel"
						...
						<h1 class="btn-dark">REGISTRATION</h1>
						<!-- 			student start -->
						<div id="studRegistraion">
							...
							<div class="row">
								...
								<div
									class="col-sm-12 offset-md-1 col-md-10 offset-lg-1 col-lg-10  offset-xl-1 col-xl-10">
									<form id="studRegisForm" novalidate>
										<div class="row">
											<div class="form-group col-sm-12 col-md-4 col-xl-4">
												...
												<div class="col-sm-12">
													<input type="text" id="s_fname" class="form-control"
											...
											<div class="form-group col-sm-12 col-md-4 col-xl-4">
												...
												<div class="col-sm-12">
													<input type="text" id="s_mname" class="form-control"
											...
											<div class="form-group col-sm-12 col-md-4 col-xl-4">
												...
												<div class="col-sm-12">
													<input type="text" id="s_lname" class="form-control"
										...
										<div class="row">
											<div class="form-group col-sm-12 col-md-4 col-xl-4">
												...
												<div class="col-sm-12">
													<input type="number" min="0" id="s_contact"
										...
										<div class="row">
											<div class="form-group col-sm-12 col-md-6 col-xl-6">
												...
												<div class="col-sm-12">
													<input type="email" id="s_Email" class="form-control"
														placeholder="Enter Student Email Id" autocomplete="off"
														required />
													<div id="EMerror"></div>
											...
											<div class="form-group col-sm-12 col-md-6 col-xl-6">
												<label class="col-sm-12 control-label">Confirm Email</label>
												<div class="col-sm-12">
													<input type="email" id="s_ParentEmail" class="form-control"
														placeholder="Confirm Email Id" autocomplete="off" required />
													<div id="CONEMerror"></div>
													<div class="invalid-feedback">Please confirm Email
														Address</div>
												</div>
											</div>
										</div>
										...
										<div class="row">
											<div class="form-group col-sm-12 col-md-6 col-xl-6">
												...
												<div class="col-sm-12">
													<input type="password" id="s_pass" minlength="6"
														placeholder="Enter password" class="form-control"
														autocomplete="new-password" required />
													<div id="Spwd_error"></div>
													<div class="invalid-feedback">Please Enter a password
														of at least 6 characters</div>
												</div>
											</div>

											<div class="form-group col-sm-12 col-md-6 col-xl-6">
												<label class="col-sm-12 control-label">Confirm
													Password</label>
												<div class="col-sm-12">
													<input type="password" id="s_conPass" minlength="6"
														placeholder="Enter confirm password" class="form-control"
														autocomplete="new-password" required />
													<div id="error"></div>
													<div class="invalid-feedback">Please enter Confirm
														Password of at least 6 characters</div>
												</div>
											</div>
										</div>
										...
										<div class="col-md-12" align="center">
											...
											<button id="studRegisNowBtn" type="submit"
												title="Register Now" class="btn btn-dark">
												<h4>REGISTER NOW</h4>
											</button>
										...
										<div class="col-sm-12" align="center"
											...
											<h2 class="darkbrown">
												<a href="login" title="Sign In">Already Registered? Sign
													in</a>
											</h2>
										</div>
										...
										<div class="row">
											...
											<div class="col-sm-6 ">
												...
												<div class="card">
													<div class="card-header"
														style="background-color: #8f826c; padding: 0px;">
														<h3>REGISTRATION AND LOGIN</h3>
													</div>
													<div class="card-body"
														style="background-color: #e9ded6ba; font-size: 20px;">
														<ul>
															<li><b>One time registration till you complete
																	the entire course content</b></li>

															<li><b>Student, teacher, school or parents can
																	register</b></li>
														</ul>
													</div>
												</div>
											...
											<div class="col-sm-6 ">
												...
												<div class="card">
													<div class="card-header"
														style="background-color: #8f826c; padding: 0px;">
														<h3>नोंदणी आणि लॉगिन</h3>
													</div>
													<div class="card-body"
														style="background-color: #e9ded6ba; font-size: 20px;">
														<ul>

															<li>तुम्ही संपूर्ण अभ्यासक्रम पूर्ण करेपर्यंत एकदाच
																नोंदणी करा</</li>
															<li>विद्यार्थी, शिक्षक, शाळा किंवा पालक नोंदणी करू
																शकतात</li>
														</ul>
													</div>
												</div>
									...
									<form id="teacherRegisForm" novalidate>
										...
										<div class="form-group ">
											...
											<div class="col-sm-12 col-md-6 col-xl-6">
												<input type="email" id="t_email" class="form-control"
										...
										<div class="row">
											<div class="form-group col-sm-12 col-md-4 col-xl-4">
												<label class="col-sm-12 control-label">First Name</label>
												<div class="col-sm-12">
													<input type="text" id="t_fname" class="form-control"
														placeholder="Enter first name" autocomplete="off" required />
													<div class="invalid-feedback">Please enter first Name</div>
												</div>
											</div>
											...
											<div class="form-group col-sm-12 col-md-4 col-xl-4">
												<label class="col-sm-12 control-label">Middle Name</label>
												<div class="col-sm-12">
													<input type="text" id="t_mname" class="form-control"
														placeholder="Enter middle name" autocomplete="off" />
												</div>
											</div>
											...
											<div class="form-group col-sm-12 col-md-4 col-xl-4">
												<label class="col-sm-12 control-label">Last Name</label>
												<div class="col-sm-12">
													<input type="text" id="t_lname" class="form-control"
														placeholder="Enter last name" autocomplete="off" required />
													<div class="invalid-feedback">Please enter Last Name</div>
												</div>
											</div>
										...
										<div class="row">
											<div class="form-group col-sm-12 col-md-4 col-xl-4">
												<label class="col-sm-12 control-label">Contact No</label>
												<div class="col-sm-12">
													<input type="number" min="0" id="t_contact" maxlength="10"
														class="form-control"
														placeholder="Enter 10 digit contact number"
														autocomplete="off" required />
											...
											<div class="form-group col-sm-12 col-md-4 col-xl-4">
												...
												<div class="col-sm-12">
													<input type="number" min="0" id="t_whatsAppNo"
														maxlength="10" class="form-control"
														placeholder="Enter 10 digit whatsApp number"
														autocomplete="off" required />
													<div id="t_WAerror"></div>
													<div class="invalid-feedback">Please enter whatsApp
														no</div>
												</div>
											</div>
										...
										<div class="row">
											<div class="form-group col-sm-12 col-md-3 col-xl-3">
												<label class="col-sm-12 control-label">Years of
													Experience</label>
												<div class="col-sm-12">
													<input type="text" id="t_yearsOfExp" class="form-control"
														autocomplete="off" required />
											...
											<div class="form-group col-sm-12 col-md-9 col-xl-9">
												...
												<div class="col-sm-12">
													<input type="text" id="t_schoolname" class="form-control"
														placeholder="Enter school name" autocomplete="off"
														required />
													<div class="invalid-feedback">Please enter school
														Name</div>
												</div>
											</div>
										</div>
										...
										<div class="row">
											<div class="form-group col-sm-12 col-md-4 col-xl-4">
												...
												<div class="col-sm-12">
													...
													<div class="invalid-feedback">Please select school
														type</div>
												</div>
											</div>
											...
											<div class="form-group col-sm-12 col-md-4 col-xl-4">
												<label class="col-sm-12 control-label">Teaching
													Group</label>
												<div class="col-sm-12">
													...
													<div class="invalid-feedback">Please select teaching
														group</div>
												</div>
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-sm-12">
												<input type="text" id="t_schooladdress" class="form-control"
													placeholder="Enter school address" autocomplete="off"
													required />
												<div class="invalid-feedback">Please enter school
													address</div>
											</div>
										...
										<div class="row">
											<div class="form-group col-sm-12 col-md-4 col-xl-4">
												...
												<div class="col-sm-12">
													<select id="t_city" class="form-control city"
														autocomplete="off" required>
											...
											<div class="form-group col-sm-12 col-md-4 col-xl-4">
												...
												<div class="col-sm-12">
													<input type="number" min="0" id="t_pincode"
														class="form-control" autocomplete="off" required />
										...
										<div class="row">
											...
											<div class="form-group col-sm-12 col-md-6 col-xl-6">
												<label class="col-sm-12 control-label">Password</label>
												<div class="col-sm-12">
													<input type="password" id="t_pass" minlength="6"
											...
											<div class="form-group col-sm-12 col-md-6 col-xl-6">
												<label class="col-sm-12 control-label">Confirm
													Password</label>
												<div class="col-sm-12">
													<input type="password" id="t_conPass" minlength="6"
														class="form-control" autocomplete="new-password" required />
										...
										<div class="col-md-12" align="center">
											...
											<button id="teacherRegisNowBtn" type="submit"
												title="Register Now" class="btn btn-dark">
												<h4>REGISTER NOW</h4>
											</button>
									...
									<form id="parentRegisForm" novalidate>
										...
										<div class="row">
											<div class="form-group col-sm-12 col-md-4 col-xl-4">
												<label class="col-sm-12 control-label">First Name</label>
												<div class="col-sm-12">
													<input type="text" id="p_fname" class="form-control"
														placeholder="Enter first name" autocomplete="off" required />
													<div class="invalid-feedback">Please enter first name
													</div>
												</div>
											</div>
											...
											<div class="form-group col-sm-12 col-md-4 col-xl-4">
												<label class="col-sm-12 control-label">Middle Name</label>
												<div class="col-sm-12">
													<input type="text" id="p_mname" class="form-control"
														placeholder="Enter middle name" autocomplete="off" />
												</div>
											</div>
											...
											<div class="form-group col-sm-12 col-md-4 col-xl-4">
												...
												<div class="col-sm-12">
													<input type="text" id="p_lname" class="form-control"
														placeholder="Enter last name" autocomplete="off" required />
													<div class="invalid-feedback">Please enter middle
														name</div>
												</div>
											</div>
										</div>
										...
										<div class="row">
											<div class="form-group col-sm-12 col-md-4 col-xl-4">
												<label class="col-sm-12 control-label">Contact No</label>
												<div class="col-sm-12">
													<input type="number" min="0" id="p_contact"
														class="form-control"
														placeholder="Enter 10 digit contact number"
														autocomplete="off" required />
													<div id="p_PHerror"></div>
													<div class="invalid-feedback">Please enter Contact no
													</div>
												</div>
											</div>
											...
											<div class="form-group col-sm-12 col-md-4 col-xl-4">
												<label class="col-sm-12 control-label">WhatsApp No</label>
												<div class="col-sm-12">
													<input type="number" min="0" id="p_whatsAppNo"
														class="form-control"
														placeholder="Enter 10 digit whatsApp number"
														autocomplete="off" required />
										...
										<div class="form-group ">
											<label class="col-sm-12 col-md-12 col-xl-12 control-label">Name
												of the School/company</label>
											<div class="col-sm-12 col-md-12 col-xl-12">
												<input type="text" id="p_company" class="form-control"
													autocomplete="off" required />
										...
										<div class="row">
											<div class="form-group col-sm-12 col-md-4 col-xl-4">
												...
												<div class="col-sm-12">
													<input type="text" id="p_qualif" class="form-control"
														autocomplete="off" required />
													<div class="invalid-feedback">Please enter
														Qualification</div>
												</div>
											...
											<div class="form-group col-sm-12 col-md-4 col-xl-4">
												...
												<div class="col-sm-12">
													<input type="text" id="p_occupation" class="form-control"
														autocomplete="off" required />
													<div class="invalid-feedback">Please enter Occupation
													</div>
												</div>
											</div>
											...
											<div class="form-group col-sm-12 col-md-4 col-xl-4">
												...
												<div class="col-sm-12">
													<input type="text" id="p_desig" class="form-control"
														autocomplete="off" required />
													<div class="invalid-feedback">Please enter
														Designation</div>
												</div>
										...
										<div class="row">
											<div class="form-group col-sm-12 col-md-4 col-xl-4">
												<label class="col-sm-12 control-label">Select City</label>
												<div class="col-sm-12">
													<select id="p_city" class="form-control city"
														autocomplete="off" required>
														<option selected="selected" value="">Select City</option>
													</select>
													<div class="invalid-feedback">Please select city</div>
											...
											<div class="form-group col-sm-12 col-md-4 col-xl-4">
												<label class="col-sm-12 control-label">Pincode</label>
												<div class="col-sm-12">
													<input type="number" min="0" id="p_pincode"
														class="form-control" autocomplete="off" required />
													<div class="invalid-feedback">Please enter Pincode</div>
												</div>
											</div>
											...
											<div class="form-group col-sm-12 col-md-4 col-xl-4">
												<label class="col-sm-12 control-label">Length of
													service</label>
												<div class="col-sm-12">
													<input type="number" id="p_service" min="0"
														class="form-control" autocomplete="off" required />
													<div class="invalid-feedback">Please enter length of
														service</div>
												</div>
											</div>
										</div>
										...
										<div class="row">
											...
											<div class="form-group col-sm-12 col-md-4 col-xl-4">
												<label class="col-sm-12 control-label">Password</label>
												<div class="col-sm-12">
													<input type="password" id="p_pass" minlength="6"
														class="form-control" autocomplete="new-password" required />
											...
											<div class="form-group col-sm-12 col-md-4 col-xl-4">
												<label class="col-sm-12 control-label">Confirm
													Password</label>
												<div class="col-sm-12">
													<input type="password" id="p_conPass" minlength="6"
														class="form-control" autocomplete="new-password" required />
													<div id="parterror"></div>
													<div class="invalid-feedback">Please enter Conform
														password of at least 6 characters</div>
												</div>
											</div>
										...
										<div class="col-md-12" align="center">
											...
											<button id="parentRegisNowBtn" type="submit"
												title="Register Now" class="btn btn-dark">
												<h4>REGISTER NOW</h4>
											</button>
					...
					<div class="tab-pane fade" id="Contributor" role="tabpanel"
									...
									<form id="contriRegisForm" novalidate>
											...
											<div class="form-group col-sm-12 col-md-4 col-xl-4">
												...
												<div class="col-sm-12">
													<input type="text" id="lname" class="form-control"
														placeholder="Enter last name" autocomplete="off" required />
													<div class="invalid-feedback">Please enter Last Name
													</div>
												</div>
											</div>
										</div>
										...
										<div class="row">
											<div class="form-group col-sm-12 col-md-4 col-xl-4">
												<label class="col-sm-12 control-label">Contact No</label>
												<div class="col-sm-12">
													<input type="number" min="0" id="contact"
														class="form-control"
														placeholder="Enter 10 digit contact number"
														autocomplete="off" required />
											...
											<div class="form-group col-sm-12 col-md-4 col-xl-4">
												<label class="col-sm-12 control-label">WhatsApp No</label>
												<div class="col-sm-12">
													<input type="number" min="0" id="whatsAppNo"
														class="form-control"
														placeholder="Enter 10 digit whatsApp number"
														autocomplete="off" required />
										...
										<div class="form-group">
											<label class="col-sm-12 col-md-12 col-xl-12 control-label">School
												Name</label>
											<div class="col-sm-12 col-md-12 col-xl-12">
												<input type="text" id="schoolname" class="form-control"
													placeholder="Enter school name" autocomplete="off" required />
												<div class="invalid-feedback">Please enter School name
												</div>
											</div>
										</div>
										...
										<div class="row">
											...
											<div class="form-group col-sm-12 col-md-4 col-xl-4">
												<label class="col-sm-12 control-label">Years of
													Experience</label>
												<div class="col-sm-12">
													<input type="text" min="0" id="yearsOfExp"
														class="form-control" autocomplete="off" required />
													<div class="invalid-feedback">Please enter Years of
														experience</div>
												</div>
										...
										<div class="row">
											...
											<div class="form-group col-sm-12 col-md-4 col-xl-4">
												<label class="col-sm-12 control-label">Pincode</label>
												<div class="col-sm-12">
													<input type="number" min="0" id="pincode"
														class="form-control" name="pincode" autocomplete="off"
														required />
													<div class="invalid-feedback">Please enter Pincode</div>
												</div>
											</div>
										...
										<div class="row">
											<div class="form-group col-sm-12 col-md-12 col-xl-12">
												<label class="col-sm-12 control-label">Question
													contributor type</label>
												<div class="col-sm-12 col-md-12 col-xl-12">
													<select id="contribType" title="Select contributor type"
														class="form-control" autocomplete="off" required>
														<option value="">-----Select-----</option>
														<option value="1">I am Interested to learn Latex
															code and provide question in latex coded form</option>
														<option value="2">I will provide question without
															latex coded form</option>
													</select>
													<div class="invalid-feedback">Please select
														contributor type</div>
													<div id="contribTypeMsg" hidden="true"
														style="color: green;">Latex code training sessions
														will be made available by us free of cost.You will get
														informed regarding such sessions.</div>
												</div>
											</div>
										</div>
										...
										<div class="col-md-12" align="center">
											...
											<button id="contriRegisNowBtn" type="submit"
												title="Register Now" class="btn btn-dark">
												<h4>REGISTER NOW</h4>
											</button>
...
// 							&& STDConPwdValidation() == true 
// 							&& STDPhnValidation() == true 
// 							&& STDWAValidation() == true 
// 							&& EmailValidation() == true ) {
		...
		$("#teacherRegisNowBtn").click(
				function(e) {
					...
					if (form.checkValidity() == true
							&& TeaConPwdValidation() == true
							&& TECPhnValidation() == true
							&& TECWAValidation() == true) {
						console.log("true");
						e.preventDefault();
		...
		$("#parentRegisNowBtn").click(
				function(e) {
					...
					if (form.checkValidity() == true
							&& ParConPwdValidation() == true
							&& PERPhnValidation() == true
							&& PERWAValidation() == true) {
						e.preventDefault();
						com.coep.test.userProfile.registerParent();
					}
				});

		$("#contriRegisNowBtn").click(
				function(e) {
					...
					if (form.checkValidity() == true
							&& ContConPwdValidation() == true
							&& CONPhnValidation() == true
							&& COMWAValidation() == true) {
						e.preventDefault();
						com.coep.test.userProfile.registerContributor();
					}
				});

		$("#s_contact").on('change', function() {
			STDPhnValidation();
		});
		$("#s_ParentEmail").on('change', function() {
			EmailValidation();
		});

		function EmailValidation() {

			var conEmail = $("#s_ParentEmail").val();
			var email = $("#s_Email").val();

			if (email !== conEmail && conEmail !== email) {
				$("#s_ParentEmail").addClass("error-text");
				$("#EMerror").html('');
				$("#s_Email").addClass("error-text");
				$("#CONEMerror").html('');

				$("#EMerror").html(
						"<span class='error'>Email Id does not match</span>");
				$("#CONEMerror").html(
						"<span class='error'>Email Id does not match</span>");
				return false;
			} else {
				$("#EMerror").html('');
				$("#s_ParentEmail").removeClass("error-text");
				$("#CONEMerror").html('');
				$("#s_Email").removeClass("error-text");
				return true;
			}
		}
		...
		function STDPhnValidation() {
			...
			if (STDPHN > 10 || STDPHN < 10) {
				...
				$("#PHerror")
						.html(
								"<span class='error'>Phone number must be 10 digit only</span>");
				return false;
			} else {
				$("#PHerror").html('');
		...
		$("#s_whatsAppNo").on('change', function() {
			STDWAValidation();
		});
		...
		function STDWAValidation() {
			...
			if (STDWPN > 10 || STDWPN < 10) {
				...
				$("#WAerror")
						.html(
								"<span class='error'>WhatsApp number must be 10 digit only</span>");
				return false;
			} else {
				$("#WAerror").html('');
		...
		function STDConPwdValidation() {
			...
			if (pwd !== confirmPwd && confirmPwd !== pwd) {
				...
				$("#error")
						.html(
								"<span class='error'>Password & Confirm password not match.</span>");
				$("#Spwd_error")
						.html(
								"<span class='error'>Password & Confirm password not match.</span>");
				return false;
		...
		$("#t_whatsAppNo").on('change', function() {
			TECWAValidation();
		});
		...
		$("#t_pass").on('change', function() {
			TeaConPwdValidation();
		});

		$("#t_conPass").on('change', function() {
			TeaConPwdValidation();
		});
		...
		$("#p_whatsAppNo").on('change', function() {
			PERWAValidation();
		});
		...
		$("#p_pass").on('change', function() {
			ParConPwdValidation();
		});

		$("#p_conPass").on('change', function() {
			ParConPwdValidation();
		});
