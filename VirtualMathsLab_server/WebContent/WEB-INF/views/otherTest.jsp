...
<body class="loading" onload="noBack();" onpageshow="if (event.persisted) noBack();" onunload="">
	  ...
	  <div class="container-fluid">
                <div class="row bodybgcolor">
                    	...
                    	<div id="otherTestDiv" class="col-sm-12 col-md-12 col-lg-12  col-xl-12">
                    
                 		<div id="other-test-heading" class="col-sm-12 col-md-12 col-lg-12  col-xl-12"></div>
                 		
						<div id="other-test-main-div" class="col-sm-12 col-md-12 col-lg-12  col-xl-12"></div>
...
<!-- form validation js  -->
	...
	<script type="text/javascript" src="resource/src/otherTestTimer.js"></script>
	<script type="text/javascript" src="resource/src/otherTest.js"></script>
	<script type="text/javascript" src="resource/src/core/otherTestOptFun.js"></script>
	...
	if (testData.done == false) {
		...
		com.coep.test.otherTest.otherTestMessage(testData.msg);

	} else {

		com.coep.test.otherTest.startOtherTest(testData, firstName);
	}
