(function(PT, TM, AM) {
		...
		PT.renderOptions = function(j, k, topicId, ansType, qTxtTemp, testData) {
		
		if(ansType == 5){ //Multiple Correct Answers 

			PT.mediaTypeQuestion(j, k, testData, topicId);
...
//							+ ""
							 ...
							 + testData.data["TOPIC"+topicId][j].QUES[k].ANS[l].ANSID
							 +"'>"
							 +"<img src='"+PT.baseURL+"media/get/getImage?mediaID="+testData.data["TOPIC"+topicId][j].QUES[k].ANS[l].content+"'  />"
//							 +"<img src=\""+PT.baseURL+"\"media/get/getImage?mediaID="+testData.data["TOPIC"+topicId][j].QUES[k].ANS[l].content+" class=\"\" />"
				    		 +"</label>"
...
})(com.coep.test.practiceTest, com.coep.test.practiceTestTimer, com.coep.test.AlertMessage);